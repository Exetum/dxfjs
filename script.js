...
` 
        ...
        DxfCircle (x_center, y_center, z_center, radius) {
...
` 
         ...
         DxfArc (x_center, y_center, z_center, radius, start_angle, end_angle) {
...
` 
        ...
        DxfText (x_point, y_point, z_point, height, textvalue) {
